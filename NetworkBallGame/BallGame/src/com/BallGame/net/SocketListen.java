...
public class SocketListen implements Callable<Socket>{
    ...
    Boolean stfu = false;
    /** 
     * The SocketListen class asynchronously waits for an incoming client connection when submitted to ExecutorService.
     * If a client connects, the accepting socket is returned for future use.
     * If the executing thread is cancelled by invocation of cancel(), null is returned.
    ...
    public void silence(){ stfu = true; }
    public void unsilence(){ stfu = false; }
