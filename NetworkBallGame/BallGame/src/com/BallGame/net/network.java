...
public class network {
    ...
    /**
     * Encapsulement for return values of connectAsClient as a tuple of [Socket,
     * Int].
     */
    ...
    /**
     * Listens for up to {@value #MAX_CLIENTS} connections on provided port and
     * returns the client-connected sockets for future use.
     * 
     ...
     * @return an integer array containing information decoded from provided
     *         info_en.
     * 
     */
